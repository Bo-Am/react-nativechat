...
export default function LoginForm() {
  ...
  return (
        <form onSubmit={handleSubmit(onSubmit)} className="centered-container-form">
          <div className="header">Добро пожаловать! </div>
          <div className="subheader">Заходите и общайтесь с людьми на любые темы!</div>
          <div className="form-container">
            ...
            <button 
            type="submit" 
            className="btn btn-outline-primary">Войти</button>
          </div>
        </form>)
}
